...
function mostrarRickAndMorty(personaje) {
    ...
    // Comparar géneros
    const usuarioGenero = document.getElementById('usuarioGenero').textContent;
    const rickAndMortyGenero = document.getElementById('rickAndMortyGenero').textContent;
    const comparacionGenero = document.getElementById('comparacionGenero');
    if (usuarioGenero === rickAndMortyGenero) {
        comparacionGenero.textContent = 'Ambos tienen el mismo género.';
    } else {
        comparacionGenero.textContent = 'Tienen géneros diferentes.';
    }
}
